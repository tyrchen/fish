...
import json
import inspect
from job.clients import Client, Admin
from job.workers import Worker, ThreadWorker
...
class Manager(models.Model):
  ...
  HANDLE_CHOICES = tuple([(name, name) for name, obj in inspect.getmembers(tasks) if inspect.isclass(obj)])
